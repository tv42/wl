...
func (p *XdgWmBase) AddPingHandler(h wl.Handler) {
	if h != nil {
		p.mu.Lock()
...
func (p *XdgWmBase) RemovePingHandler(h wl.Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func NewXdgPositioner(ctx *wl.Context) *XdgPositioner {
...
func (p *XdgSurface) AddConfigureHandler(h wl.Handler) {
	if h != nil {
		p.mu.Lock()
...
func (p *XdgSurface) RemoveConfigureHandler(h wl.Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
//
func (p *XdgSurface) GetToplevel() (*XdgToplevel, error) {
	ret := NewXdgToplevel(p.Context())
	return ret, p.Context().SendRequest(p, 1, wl.Proxy(ret))
}
...
//
func (p *XdgSurface) GetPopup(parent *XdgSurface, positioner *XdgPositioner) (*XdgPopup, error) {
	ret := NewXdgPopup(p.Context())
...
func (p *XdgToplevel) AddConfigureHandler(h wl.Handler) {
	if h != nil {
		p.mu.Lock()
		p.configureHandlers = append(p.configureHandlers, h)
		p.mu.Unlock()
...
func (p *XdgToplevel) RemoveConfigureHandler(h wl.Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func (p *XdgToplevel) AddCloseHandler(h wl.Handler) {
	if h != nil {
		p.mu.Lock()
...
func (p *XdgToplevel) RemoveCloseHandler(h wl.Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func NewXdgToplevel(ctx *wl.Context) *XdgToplevel {
	ret := new(XdgToplevel)
	ctx.Register(ret)
	return ret
}
...
//
func (p *XdgToplevel) Destroy() error {
	return p.Context().SendRequest(p, 0)
}
...
// parent surface.
//
func (p *XdgToplevel) SetParent(parent *XdgToplevel) error {
...
//
func (p *XdgToplevel) SetTitle(title string) error {
...
//
func (p *XdgToplevel) SetAppId(app_id string) error {
...
//
func (p *XdgToplevel) ShowWindowMenu(seat *wl.Seat, serial uint32, x int32, y int32) error {
...
//
func (p *XdgToplevel) Move(seat *wl.Seat, serial uint32) error {
...
//
func (p *XdgToplevel) Resize(seat *wl.Seat, serial uint32, edges uint32) error {
...
// protocol error.
//
func (p *XdgToplevel) SetMaxSize(width int32, height int32) error {
...
// protocol error.
//
func (p *XdgToplevel) SetMinSize(width int32, height int32) error {
...
//
func (p *XdgToplevel) SetMaximized() error {
...
// unmaximized if not overridden by the compositor.
//
func (p *XdgToplevel) UnsetMaximized() error {
...
//
func (p *XdgToplevel) SetFullscreen(output *wl.Output) error {
...
//
func (p *XdgToplevel) UnsetFullscreen() error {
...
//
func (p *XdgToplevel) SetMinimized() error {
...
func (p *XdgPopup) AddConfigureHandler(h wl.Handler) {
	if h != nil {
		p.mu.Lock()
		p.configureHandlers = append(p.configureHandlers, h)
		p.mu.Unlock()
...
func (p *XdgPopup) RemoveConfigureHandler(h wl.Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func (p *XdgPopup) AddPopupDoneHandler(h wl.Handler) {
	if h != nil {
		p.mu.Lock()
...
func (p *XdgPopup) RemovePopupDoneHandler(h wl.Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
//
func (p *XdgPopup) Grab(seat *wl.Seat, serial uint32) error {
