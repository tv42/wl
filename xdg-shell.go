...
func (p *XdgWmBase) AddPingHandler(h Handler) {
	if h != nil {
		p.mu.Lock()
...
func (p *XdgWmBase) RemovePingHandler(h Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
//
func (p *XdgWmBase) GetXdgSurface(surface *Surface) (*XdgSurface, error) {
...
func (p *XdgSurface) AddConfigureHandler(h Handler) {
	if h != nil {
		p.mu.Lock()
...
func (p *XdgSurface) RemoveConfigureHandler(h Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func (p *XdgToplevel) AddConfigureHandler(h Handler) {
	if h != nil {
		p.mu.Lock()
		p.configureHandlers = append(p.configureHandlers, h)
		p.mu.Unlock()
...
func (p *XdgToplevel) RemoveConfigureHandler(h Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func (p *XdgToplevel) AddCloseHandler(h Handler) {
	if h != nil {
		p.mu.Lock()
...
func (p *XdgToplevel) RemoveCloseHandler(h Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func (p *XdgToplevel) Dispatch(event *Event) {
	switch event.opcode {
	case 0:
		if len(p.configureHandlers) > 0 {
...
func NewXdgToplevel(ctx *Context) *XdgToplevel {
	ret := new(XdgToplevel)
	ctx.register(ret)
	return ret
}
...
//
func (p *XdgToplevel) ShowWindowMenu(seat *Seat, serial uint32, x int32, y int32) error {
...
//
func (p *XdgToplevel) Move(seat *Seat, serial uint32) error {
...
//
func (p *XdgToplevel) Resize(seat *Seat, serial uint32, edges uint32) error {
...
//
func (p *XdgToplevel) SetFullscreen(output *Output) error {
...
func (p *XdgPopup) AddConfigureHandler(h Handler) {
	if h != nil {
		p.mu.Lock()
		p.configureHandlers = append(p.configureHandlers, h)
		p.mu.Unlock()
...
func (p *XdgPopup) RemoveConfigureHandler(h Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func (p *XdgPopup) AddPopupDoneHandler(h Handler) {
	if h != nil {
		p.mu.Lock()
...
func (p *XdgPopup) RemovePopupDoneHandler(h Handler) {
	p.mu.Lock()
	defer p.mu.Unlock()
...
func (p *XdgPopup) Dispatch(event *Event) {
	switch event.opcode {
	case 0:
		if len(p.configureHandlers) > 0 {
...
func NewXdgPopup(ctx *Context) *XdgPopup {
	ret := new(XdgPopup)
	ctx.register(ret)
	return ret
}
